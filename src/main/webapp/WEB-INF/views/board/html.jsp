 	...
 	<h1>HTML 게시판</h1>
			...
			<c:otherwise>
				...
				<c:forEach var="imsi" items="${menu}"> 
					...
					<div class='image1'><a href = 'detailView?contents=${imsi.contents}&image=${imsi.image}&title=${imsi.title}&lang=${imsi.lang}&num=${imsi.num}&date1=${imsi.date1}&user_id=${principal.user.username}&writer=${imsi.user_id}&hit=${imsi.hit}&user_num=${imsi.user_num}&user_num=${imsi.user_num}'>
